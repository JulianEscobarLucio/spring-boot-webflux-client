package com.bolsadeideas.springboot.webflux.cliente.app.handler;
...
import com.bolsadeideas.springboot.webflux.cliente.app.sevices.ProductoService;
...
public class ProductoHandler {
	...
	public Mono<ServerResponse> crear(ServerRequest request) {
		...
		}).flatMap(p -> ServerResponse.created(URI.create("/api/cliente/".concat(p.getId())))
				.contentType(APPLICATION_JSON)
				.syncBody(p))
				.onErrorResume( error -> {
